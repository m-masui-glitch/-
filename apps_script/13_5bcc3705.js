// =====================================================================
// 回数券集計スクリプト — CSVファイル: 5bcc3705
// 顧客数: 257名（参考）  列レイアウト: タイプB（列オフセット+1）
//
// 【使い方】
...
const COL_T    = 13;  // 3回券完了マーカーの列
const COL_3K   = 14;  // 3回券セッション開始列（1/3 の列）
const COL_GRP  = 17;  // 最初の7列グループ開始列（チケット購入履歴）
// ====================================
